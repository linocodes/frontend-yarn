  ...
  render() {
    ...
    return (
      <div>
            ...
            <MatTableToolbar numSelected={selected.length} handleDeleteSelected={this.handleDeleteSelected}/>
                    ...
                    .map(d => {
                      ...
                      return (
                        <TableRow className='material-table__row'
                          ...
                          <TableCell className='material-table__cell' component='th'
                                     scope='row' padding='none'>{d.name}</TableCell>
