...
export default class AddNewNavItem extends PureComponent {
  render() {
    return (
      <Card className='card--not-full-height'>
        <CardBody>
          ...
          <p>The template uses <a href='https://github.com/ReactTraining/react-router'>react-router</a> for navigation.
            Add a new Route in <b>template/src/app/Router.js</b> to add new navigation item: </p>
          <CodeHighlither>
