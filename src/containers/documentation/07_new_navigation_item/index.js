  ...
  render() {
    return (
      <Container className='documentation'>
            ...
            <Col md={12} lg={3} xl={3} sm={12} xs={12} className='documentation__nav'>
              <Sticky topOffset={-90} bottomOffset={95}>
                {({
                  ...
                  return <Navigation active='navigation_item' style={style} stick={isSticky}/>;
                }}
              </Sticky>
            </Col>
        ...
        <NavigationBottom prevLink='/documentation/color_themes' prevTitle='Color Themes'
                          nextLink='/documentation/resources' nextTitle='Resources'/>
      </Container>
    )
  }
}
