  ...
  render() {
    return (
      <Container className='documentation'>
            ...
            <Col md={12} lg={3} xl={3} sm={12} xs={12} className='documentation__nav'>
              <Sticky topOffset={-90} bottomOffset={95}>
                {({
                  ...
                  return <Navigation active='installation' style={style} stick={isSticky}/>;
                }}
              </Sticky>
            </Col>
        ...
        <NavigationBottom prevLink='/documentation/introduction' prevTitle='Introduction'
                          nextLink='/documentation/file_structure' nextTitle='File Structure'/>
      </Container>
    )
  }
}
