...
export default class ScssStructure extends PureComponent {
  render() {
    return (
      <Card className='card--not-full-height'>
        <CardBody>
          ...
          <p>You can learn more about SASS (Syntactically Awesome Style Sheets) on <a
            href='https://sass-lang.com/'>sass-lang.com</a></p>
