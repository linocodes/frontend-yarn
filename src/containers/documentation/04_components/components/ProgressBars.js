    ...
    return (
      <div className='progress-wrap'>
        <Progress value={70}>70%</Progress>
          ...
          <ol>
            <li>To change color: <span className='red-text'>'progress-wrap--yellow'</span>, <span
              className='red-text'>'progress-wrap--violet'</span>, <span
              className='red-text'>'progress-wrap--pink'</span>, <span className='red-text'>'progress-wrap--blue'</span>
            </li>
            <li>To change size: <span className='red-text'>'progress-wrap--small'</span>, <span
              className='red-text'>'progress-wrap--middle'</span>, <span
              className='red-text'>'progress-wrap--big'</span>
            </li>
          </ol>
