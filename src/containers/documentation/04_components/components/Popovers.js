    ...
    return (
      <Card className='card--not-full-height'>
        <CardBody>
          ...
          <p>Popovers are based on <a href='https://reactstrap.github.io/components/popovers/'>reactstrap</a>. Example of
    ...
    return (
      <ButtonToolbar className='btn-toolbar--center'>
        ...
        <Popover placement='top' isOpen={this.state.popoverOpen} target='PopoverTop'
          ...
          <p>All props <a href='https://reactstrap.github.io/components/popovers/'>here</a>.</p>
