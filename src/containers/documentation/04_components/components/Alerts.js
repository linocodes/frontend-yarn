    ...
    return (
      <Card className='card--not-full-height'>
        <CardBody>
          ...
          <p>Alerts are based on <a href='https://reactstrap.github.io/components/alerts/'>reactstrap</a>. Example:</p>
          <CodeHighlither>
            {`import React, {PureComponent} from 'react';
        ...
        <p><span className='bold-text'>Information:</span> Learning day desirous informed expenses
          ...
          <Table responsive className='table--bordered table--head-accent'>
            ...
            <tr>
              <td>color</td>
              <td>string</td>
              <td>One of the following colors: <span className='red-text'>'info'</span>, <span
            ...
            <tr>
              <td>className</td>
              <td>string</td>
              <td>One of the following styles: <span className='red-text'>'alert--bordered'</span>, <span
                className='red-text'>'alert--colored'</span>, <span className='red-text'>'alert--neutral'</span> or your
                own
              </td>
            </tr>
            </tbody>
