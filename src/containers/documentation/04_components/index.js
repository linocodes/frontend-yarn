  ...
  render() {
    return (
      <Container className='documentation'>
            ...
            <Col md={12} lg={3} xl={3} sm={12} xs={12} className='documentation__nav'>
              <Sticky topOffset={-90} bottomOffset={95}>
                {({
                  ...
                  return <Navigation active='components' style={style} stick={isSticky}/>;
                }}
              </Sticky>
            </Col>
        ...
        <NavigationBottom prevLink='/documentation/file_structure' prevTitle='File Structure'
                          nextLink='/documentation/form' nextTitle='Form'/>
      </Container>
    )
  }
}