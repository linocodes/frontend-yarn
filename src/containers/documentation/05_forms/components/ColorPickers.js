...
export default class ColorPickers extends PureComponent {
  render() {
    return (
      <Card className='card--not-full-height'>
        <CardBody>
          ...
          <p>ColorPickers are based on <a href='https://github.com/casesandberg/react-color/'>react-color</a>.
            There are three types of these pickers: sketch, block and chrome. Example of using one of them:</p>
          <CodeHighlither>
...
/>`}
          ...
          <p>You can find other types of color pickers <a href='http://casesandberg.github.io/react-color/'>here </a>
            and create your own in this template.</p>
